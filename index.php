...
<body>
    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header" style="background-color: #072943;">
            <!-- Logo Header -->
            <div class="container">
                <div class="logo-header" data-background-color="gray">

                    <a href="#">
                        <img src="logo-removebg-preview.png" alt="navbar brand" class="navbar-brand" width="40">
                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SMK PGRI WANARAJA</h2>
    ...
    <footer class="footer">
        <div class="container">
            <div class="copyright ml-auto">
                &copy; <?php echo date('Y');?> Absensi Siswa SMK PGRI WANARAJA (<a href="index.php">Muhamad hamzah </a>
                | 2023)
            </div>
        </div>
    </footer>
