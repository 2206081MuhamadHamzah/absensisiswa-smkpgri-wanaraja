...
$id_login = @$_SESSION['id_guru'];
 // $id_guru adalah ID guru yang berhasil login
...
"></i>
		...
		<div class="main-panel">
			<div class="content">
				...
				}elseif ($act == 'rekap-persemester') {
					$pelajaran = @$_GET['pelajaran'];
					$kelas = @$_GET['kelas'];
					include 'modul/rekap/rekap_persemester.php';
				}elseif ($page=='jadwal') {
					if ($act=='') {
    ...
    <div class="container">
        <div class="copyright ml-auto">
            &copy; <?php echo date('Y');?> Absensi SMK PGRI WANARAJA (<a href="index.php">Muhamad Hamzah </a> | 2023)
        </div>
    </div>
    ...
    $('#basic-datatables').DataTable({
        "pageLength": 50 // Menampilkan 50 entries per halaman
    });
    ...
    $('#addRowButton').click(function() {
        $('#add-row').dataTable().fnAddData([
            ...
            $("#addPosition").val(),
            $("#addOffice").val(),
            action // Pastikan 'action' didefinisikan di bagian lain dalam kode
        ]);
