...
if (!isset($data) || empty($data)) {
    ...
    // Kemudian bisa melakukan redirect atau tindakan lain yang sesuai.
    exit;
}
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					...
					<b class="text-white">SMK PGRI WANARAJA</b>
				</a>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
    <a href="modul/absen/kehadiran.php?id=<?php echo $data['id_siswa']; ?>">
...
<li class="nav-item">
    <a href="modul/absen/surat_izin.php?id=<?php echo $data['id_siswa']; ?>">
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa SMK PGRI WANARAJA (<a href="index.php">Muhamad Hamzah </a> | 2023)
					</div>				
				</div>
			</footer>
		</div>
