							...
							<div class="card full-height">
								<div class="card-body">
										...
										<center>
											...
											<br>
											<b>SMK PGRI WANARAJA</b>
										</center>
									</div>
									<div class="card-category">
										<center>
										Jl. Koropeak No.771, Cinunuk, Kec. Sucinaraja, Kabupaten Garut, Jawa Barat 44183
	<br>yahoo :smkpgriwanaraja@yahoo.com Telp.(0262)444234
										</center>
									</div>
							...
							<!-- 	<div class="card-header">
								...
								<div class="card-body">
									<ul class="nav nav-pills nav-secondary  nav-pills-no-bd nav-pills-icons justify-content-center" id="pills-tab-with-icon" role="tablist">
										...
										<a class="nav-link" href="modul/absen/kehadiran.php?id=<?php echo $data['id_siswa']; ?>">
